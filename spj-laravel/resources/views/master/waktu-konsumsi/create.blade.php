...
@section('title', 'Tambah Waktu Konsumsi')
@section('page-title', 'Tambah Waktu Konsumsi')
@section('page-subtitle', 'Tambahkan waktu konsumsi baru')

@section('content')
    <div class="max-w-2xl">
        <div class="bg-white rounded-lg border border-gray-200">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="font-semibold text-gray-900">Form Tambah Waktu Konsumsi</h3>
            </div>

            <form action="{{ route('master.waktu-konsumsi.store') }}" method="POST" class="p-6 space-y-4">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" name="kode_waktu" id="kode_waktu" value="{{ old('kode_waktu') }}"
